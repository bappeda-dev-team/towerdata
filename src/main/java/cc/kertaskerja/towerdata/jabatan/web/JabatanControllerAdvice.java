...
import cc.kertaskerja.towerdata.jabatan.domain.exception.JabatanAlreadyExistException;
...
public class JabatanControllerAdvice {
    ...
    @ResponseStatus(HttpStatus.NOT_FOUND)
    String jabatanAlreadyExistException(JabatanAlreadyExistException ex) {
        return ex.getMessage();
    }
